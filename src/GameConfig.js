...
class GameConfig extends React.Component {
	...
	onChangeChGp = (evt) => {
		if (evt.target.name === 'ch-value-colors') {
			...
			this.setState({ restrictedMoves: evt.target.checked });
		}
	};
				...
				<BlackCadre width={436} borderWidth={15} padding={10} title='Game Configuration'>
					<div>
						<BlackCadre width={350} borderWidth={15} title='Board Size' >
							<div>
								...
								<div style={radBsStyle} >
									<input id='rad2x1' type='radio' name='rg-bs' value={this.state.boardSize === 'rad2x1'} onChange={this.onChangeRadBs} />
									<label><b>&nbsp; 2 x 1</b></label>
								</div>
								<div style={radBsStyle} >
									<input id='rad2x3' type='radio' name='rg-bs' value={this.state.boardSize === 'rad2x3'} onChange={this.onChangeRadBs} />
									<label><b>&nbsp; 2 x 3</b></label>
								</div>
								<div style={radBsStyle} >
									<input id='rad3x1' type='radio' name='rg-bs' value={this.state.boardSize === 'rad3x1'} onChange={this.onChangeRadBs} />
									<label><b>&nbsp; 3 x 1</b></label>
								</div>
								<div style={radBsStyle} >
									<input id='rad3x3' type='radio' name='rg-bs' value={this.state.boardSize === 'rad3x3'} onChange={this.onChangeRadBs} />
									<label><b>&nbsp; 3 x 3</b></label>
								</div>
								<div style={radBsStyle} >
									<input id='rad4x1' type='radio' name='rg-bs' value={this.state.boardSize === 'rad4x1'} onChange={this.onChangeRadBs} />
									<label><b>&nbsp; 4 x 1</b></label>
								</div>
								<div style={radBsStyle} >
									<input id='rad4x3' type='radio' name='rg-bs' value={this.state.boardSize === 'rad4x3'} onChange={this.onChangeRadBs} />
									<label><b>&nbsp; 4 x 3</b></label>
								</div>
								<div style={radBsStyle} >
									<input id='rad5x1' type='radio' name='rg-bs' value={this.state.boardSize === 'rad5x1'} onChange={this.onChangeRadBs} />
									<label><b>&nbsp; 5 x 1</b></label>
								</div>
								<div style={radBsStyle} >
									<input id='rad5x3' type='radio' name='rg-bs' value={this.state.boardSize === 'rad5x3'} onChange={this.onChangeRadBs} />
						...
						<BlackCadre width={350} borderWidth={15} padding={10} title='Game Parameters' >
							<div style={configDifficultyChecksStyle} >
								<div style={chDivStyle} >
									<input type='checkbox' name='ch-value-colors' value={this.state.valueColors} onChange={this.onChangeChGp} />
									<label><b>&nbsp; Cell Valued Colors</b></label>
								</div>
								<div style={chDivStyle} >
									<input type='checkbox' name='ch-playing-hints' value={this.state.playingHints} onChange={this.onChangeChGp} />
									<label><b>&nbsp; Playing Hints</b></label>
								</div>
								<div style={chDivStyle} >
									<input type='checkbox' name='ch-no-negatives' value={this.state.noNegatives} onChange={this.onChangeChGp} />
						...
						<div>
							...
							<div style={radVpStyle} >
								<input id='radFixed100' type='radio' name='rg-vp' value={this.state.valuePool === 'radFixed100'} onChange={this.onChangeRadVp} />
								<label><b>&nbsp; Fixed 100</b></label>
							</div>
							<div style={radVpStyle} >
								<input id='radFixed1000' type='radio' name='rg-vp' value={this.state.valuePool === 'radFixed1000'} onChange={this.onChangeRadVp} />
